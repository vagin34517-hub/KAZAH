...
const dict: Record<Lang, Record<string, string>> = {
  ru: {
    ...
    invite_friends: "Пригласить друзей", copy_link: "Копировать ссылку", link_copied: "Ссылка скопирована",
    ...
    topup_soon: "Пополнение через TON Connect — скоро. Пока баланс начисляет админ через бота.",
  },
  en: {
    ...
    invite_friends: "Invite friends", copy_link: "Copy link", link_copied: "Link copied",
    ...
    topup_soon: "TON Connect top-up coming soon. For now admin tops up via bot.",
  },
  ua: {
    ...
    invite_friends: "Запросити друзів", copy_link: "Копіювати посилання", link_copied: "Посилання скопійовано",
    ...
    topup_soon: "ТОН-поповнення скоро. Поки баланс нараховує адмін через бота.",
  },
}
